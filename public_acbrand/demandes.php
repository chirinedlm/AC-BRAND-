...
<main class="container">
  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-0">Toutes les demandes (
    ...
    <table class="table table-light">
      ...
      <tbody>
        <?php 
$i = 0;
$select = mysqli_query($conn,"SELECT * FROM `orders` ORDER BY id DESC");
...
?>
        <tr>
          ...
          <td><?= $row['product_prcie'] . "Da  / ".$row['quantity']. " Pièces"; ?> </td>
